package cn.leancloud.xb.talk;

import cn.leancloud.xb.talk.exception.RobotApiEndException;
...
public class TuringRobot implements Robot {
    ...
    private final static String apiKey = "3085f5240d1f4417aed8fe38ca6f9172";
    private final static String userId = "biedalian";
